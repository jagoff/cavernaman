...
$HookFiles = @("package.json", "caveman-config.js", "caveman-session-prompt.js", "caveman-activate.js", "caveman-mode-tracker.js", "caveman-stats.js", "caveman-statusline.sh", "caveman-statusline.ps1")
...
Write-Host "  - Statusline badge: shows [CAVERNAMAN] or [CAVERNAMAN:ULTRA] etc."
